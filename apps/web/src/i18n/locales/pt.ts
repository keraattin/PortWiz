...
export const pt: Partial<Record<TKey, string>> = {
  ...
  "ports.fp.badge": "FP",
  "ports.fp.marked": "Porta {port} marcada como falso positivo",
  "ports.fp.restored": "Porta {port} restaurada",
  ...
  "portinfo.20": "Canal de dados FTP, emparelhado com a porta de controle 21. Sem criptografia.",
  "portinfo.21": "File Transfer Protocol. Transfere arquivos entre hosts; credenciais e dados trafegam sem criptografia.",
  "portinfo.22": "Secure Shell. Login remoto e execução de comandos criptografados.",
  "portinfo.23": "Login remoto sem criptografia. Legado e inseguro; evite expor.",
  "portinfo.25": "Simple Mail Transfer Protocol. Entrega de e-mail entre servidores.",
  "portinfo.53": "Domain Name System. Resolve nomes de host em endereços IP.",
  "portinfo.67": "Distribui endereços IP aos hosts da rede.",
  "portinfo.69": "Trivial File Transfer Protocol. Sem autenticação; frequentemente usado para firmware de dispositivos.",
  "portinfo.80": "Tráfego web sem criptografia. Geralmente redireciona para HTTPS.",
  "portinfo.110": "Recupera e-mail de uma caixa; a variante em texto puro.",
  "portinfo.123": "Network Time Protocol. Sincroniza o relógio pela rede.",
  "portinfo.135": "Mapeador de endpoints RPC do Windows. Comum em redes Windows internas.",
  "portinfo.139": "Compartilhamento de arquivos Windows legado via NetBIOS.",
  "portinfo.143": "Lê e-mail no servidor; a variante em texto puro.",
  "portinfo.161": "Monitoramento e gerenciamento de dispositivos de rede. Community strings fracas são um risco comum.",
  "portinfo.389": "Serviço de diretório para usuários e grupos; a variante em texto puro.",
  "portinfo.443": "Tráfego web sobre TLS. O padrão para sites seguros.",
  "portinfo.445": "Compartilhamento de arquivos e impressoras do Windows. Alvo frequente de malware e ransomware.",
  "portinfo.465": "Envio de e-mail SMTP sobre TLS.",
  "portinfo.514": "Registro remoto. Frequentemente sem autenticação via UDP.",
  "portinfo.587": "Envio de e-mail autenticado de clientes para um servidor de e-mail.",
  "portinfo.636": "Serviço de diretório LDAP sobre TLS.",
  "portinfo.993": "Acesso a e-mail IMAP sobre TLS.",
  "portinfo.995": "Recuperação de e-mail POP3 sobre TLS.",
  "portinfo.1433": "Banco de dados Microsoft SQL Server.",
  "portinfo.1521": "Listener de banco de dados Oracle.",
  "portinfo.2049": "Network File System. Sistemas de arquivos compartilhados, frequentemente confiáveis por IP.",
  "portinfo.2375": "API do daemon Docker. Exposição sem autenticação concede controle total do host.",
  "portinfo.3306": "Banco de dados MySQL / MariaDB.",
  "portinfo.3389": "Área de Trabalho Remota do Windows. Alvo comum de força bruta e ransomware.",
  "portinfo.5432": "Banco de dados PostgreSQL.",
  "portinfo.5900": "Compartilhamento de área de trabalho remota. Frequentemente com autenticação fraca.",
  "portinfo.6379": "Armazenamento de dados em memória Redis. Frequentemente exposto sem senha.",
  "portinfo.8080": "Porta HTTP alternativa, frequentemente um servidor de aplicação ou proxy.",
  "portinfo.8443": "Porta HTTPS alternativa, frequentemente um console de administração ou proxy.",
  "portinfo.9200": "API de busca e análise Elasticsearch. Clusters expostos vazam dados.",
  "portinfo.11211": "Cache Memcached. Instâncias expostas são abusadas para amplificação de DDoS.",
  "portinfo.27017": "Banco de dados MongoDB. Historicamente exposto sem autenticação.",
  ...
  "assetDetail.evidence": "Evidência",
  "assetDetail.evidenceHint":
    "Baixe um pacote de evidências assinado para este host: portas abertas, CVEs, alterações e integridade da auditoria.",
  ...
  "teams.title": "Equipes",
  "teams.subtitle": "Grupos de usuários nomeados aos quais ativos e VLANs podem ser atribuídos.",
  "teams.add": "Adicionar equipe",
  "teams.empty": "Nenhuma equipe ainda",
  "teams.emptyBody": "Crie uma equipe para agrupar usuários e atribuir ativos e VLANs a ela.",
  "teams.created": "Equipe criada",
  "teams.deleted": "Equipe excluída",
  "teams.confirmDelete": "Excluir esta equipe? Os ativos e VLANs atribuídos a ela ficarão sem atribuição.",
  "teams.col.name": "Nome",
  "teams.col.description": "Descrição",
  "teams.col.members": "Membros",
  "teams.members": "Membros",
  "teams.membersOf": "Membros de {name}",
  "teams.noMembers": "Nenhum membro ainda.",
  ...
  "assets.importStagingTitle": "Revisar importação",
  "assets.rows": "linhas",
  ...
  "assets.syncStagingTitle": "Revisar a sincronização do NetBox",
  "assets.syncStagingHint": "Escolha quais hosts importar e defina os atributos dos selecionados.",
  "assets.syncKeepDefault": "Manter padrão",
  "assets.syncStatus": "Status",
  "assets.syncNew": "Novo",
  "assets.syncExists": "Existente",
  "assets.syncNothing": "Nada para importar.",
  "assets.syncImportSelected": "Importar selecionados",
  "assets.hosts": "hosts",
  ...
  "vlans.syncStagingTitle": "Revisar sincronização de VLAN",
  "vlans.importStagingTitle": "Revisar importação de VLAN",
  ...
  "ranges.syncTitle": "Sincronizar faixas do NetBox",
  "ranges.syncStagingTitle": "Revisar sincronização de faixas",
  "segments.title": "Segmentos de rede",
  "segments.subtitle": "Agentes e perfis de varredura agrupados pelo segmento que atendem.",
  "segments.unsegmented": "Pool sem segmento",
  "segments.covered": "Coberto",
  "segments.gap": "Lacuna de cobertura",
  "segments.idle": "Ocioso",
  "segments.agents": "Agentes",
  "segments.profiles": "Perfis de varredura",
  "segments.noAgents": "Nenhum agente",
  "segments.noProfiles": "Nenhum perfil",
  "segments.empty": "Ainda sem segmentos",
  "segments.emptyBody": "Registre um agente com um segmento ou direcione um perfil de varredura para um, e ele aparece aqui.",
  ...
  "agents.deploy.download": "Baixar o binário pré-compilado",
  "agents.deploy.downloadHint": "Baixe o arquivo para o seu sistema operacional e arquitetura em",
  "agents.deploy.releasesLink": "a página de releases do PortWiz.",
  "agents.deploy.orBuild": "Ou compile a partir do código-fonte (requer o toolchain Go)",
  ...
  "timeline.title": "Histórico de alterações",
  "timeline.hint": "Aberturas, fechamentos e mudanças de serviço ou versão confirmadas ao longo do tempo.",
  "timeline.empty": "Nenhuma alteração registrada ainda.",
  "changeDetail.back": "Voltar às alterações",
  "changeDetail.notFound": "Alteração não encontrada.",
  "changeDetail.audit": "Trilha de auditoria",
  "changeDetail.noAudit": "Nenhuma entrada de auditoria para esta alteração.",
  ...
  "users.you": "(você)",
  "userDetail.back": "Voltar aos usuários",
  "userDetail.notFound": "Usuário não encontrado.",
  "userDetail.edit": "Editar usuário",
  "userDetail.activity": "Atividade",
  "userDetail.noActivity": "Nenhuma atividade registrada para este usuário.",
  ...
  "scans.ports.top100": "Varredura rápida (top 100 portas)",
  "scans.ports.db": "Bancos de dados e caches (3306, 5432, 6379…)",
  ...
  "scans.runDetailTitle": "Execução de varredura",
  "scans.back": "Voltar para varreduras",
  "scans.runNotFound": "Execução de varredura não encontrada.",
  "scans.meta.agent": "Agente",
  "scans.meta.scanSource": "Origem da varredura",
  "scans.meta.created": "Criado",
  "scans.meta.error": "Erro",
  "scans.observationsTitle": "Portas abertas",
  "scans.groupBy": "Agrupar por",
  "scans.groupNone": "Nenhum",
  "scans.groupHost": "Host",
  "scans.groupPort": "Porta",
  "scans.changesTitle": "Alterações desta varredura",
  "scans.exportJira": "Exportar para o Jira",
  "scans.exporting": "Exportando...",
  "scans.jiraExported": "{exported} exportado(s) para o Jira, {linked} já vinculado(s).",
  "scans.jiraNotConfigured": "Configure o Jira nas Configurações para habilitar a exportação.",
  "scans.noChanges": "Esta varredura não gerou nenhuma alteração.",
  ...
  "audit.action.agent_deleted": "Agente excluído",
  "audit.action.agent_enrolled": "Agente registrado",
  "audit.action.agent_token_rotated": "Token do agente rotacionado",
  "audit.action.agent_updated": "Agente atualizado",
  "audit.action.asset_created": "Ativo criado",
  "audit.action.asset_deleted": "Ativo excluído",
  "audit.action.asset_bulk_created": "Ativos criados em massa",
  "audit.action.asset_bulk_deleted": "Ativos excluídos em massa",
  "audit.action.asset_bulk_updated": "Ativos atualizados em massa",
  "audit.action.asset_imported": "Ativos importados",
  "audit.action.asset_pushed": "Ativos enviados ao inventário",
  "audit.action.asset_synced": "Ativos sincronizados",
  "audit.action.asset_updated": "Ativo atualizado",
  "audit.action.auth_login_failed": "Falha no login",
  "audit.action.auth_login_success": "Login bem-sucedido",
  "audit.action.change_status_updated": "Status da mudança atualizado",
  "audit.action.cve_feed_imported": "Feed de CVE importado",
  "audit.action.cve_rechecked": "CVEs reverificadas",
  "audit.action.evidence_exported": "Evidência exportada",
  "audit.action.ip_range_created": "Faixa de IP criada",
  "audit.action.ip_range_deleted": "Faixa de IP excluída",
  "audit.action.ip_range_bulk_created": "Faixas de IP criadas em massa",
  "audit.action.ip_range_bulk_deleted": "Faixas de IP excluídas em massa",
  "audit.action.ip_range_bulk_updated": "Faixas de IP atualizadas em massa",
  "audit.action.ip_range_updated": "Faixa de IP atualizada",
  "audit.action.observations_pruned": "Observações podadas",
  "audit.action.scan_profile_created": "Perfil de varredura criado",
  "audit.action.scan_profile_deleted": "Perfil de varredura excluído",
  "audit.action.scan_profile_updated": "Perfil de varredura atualizado",
  "audit.action.scan_run_dispatched": "Varredura despachada",
  "audit.action.scan_run_ingested": "Resultados de varredura ingeridos",
  "audit.action.scan_run_jira_exported": "Varredura exportada para o Jira",
  "audit.action.scan_run_scheduled": "Varredura agendada",
  "audit.action.scan_run_triggered": "Varredura acionada",
  "audit.action.settings_updated": "Configurações atualizadas",
  "audit.action.task_created": "Tarefa criada",
  "audit.action.task_deleted": "Tarefa excluída",
  "audit.action.task_jira_linked": "Tarefa vinculada ao Jira",
  "audit.action.task_jira_synced": "Tarefa sincronizada com o Jira",
  "audit.action.task_updated": "Tarefa atualizada",
  "audit.action.update_requested": "Atualização solicitada",
  "audit.action.user_created": "Usuário criado",
  "audit.action.user_seeded_admin": "Administrador inicial criado",
  "audit.action.user_updated": "Usuário atualizado",
  "audit.action.vlan_created": "VLAN criada",
  "audit.action.vlan_deleted": "VLAN excluída",
  "audit.action.vlan_bulk_created": "VLANs criadas em massa",
  "audit.action.vlan_bulk_deleted": "VLANs excluídas em massa",
  "audit.action.vlan_bulk_updated": "VLANs atualizadas em massa",
  "audit.action.vlan_imported": "VLANs importadas",
  "audit.action.vlan_synced": "VLANs sincronizadas",
  "audit.action.vlan_updated": "VLAN atualizada",
  ...
  "settings.email.verifyTls": "Verificar o certificado TLS",
  "settings.email.verifyTlsHint":
    "Desative para um relay interno que apresenta um certificado autoassinado ou de CA interna (evita CERTIFICATE_VERIFY_FAILED).",
  ...
  "assistant.act.asset_bulk_create": "Adicionar vários ativos",
  "assistant.act.asset_bulk_delete": "Excluir vários ativos",
  "assistant.act.asset_bulk_update": "Atualizar vários ativos",
  "assistant.act.vlan_bulk_create": "Adicionar várias VLANs",
  "assistant.act.vlan_bulk_delete": "Excluir várias VLANs",
  "assistant.act.iprange_bulk_create": "Adicionar várias faixas de IP",
  "assistant.act.iprange_bulk_delete": "Excluir várias faixas de IP",
