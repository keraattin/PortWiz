...
export const es: Partial<Record<TKey, string>> = {
  ...
  "ports.fp.show": "Mostrar falsos positivos",
  "ports.fp.mark": "Marcar como falso positivo",
  "ports.fp.restore": "Restaurar",
  "ports.fp.badge": "FP",
  "ports.fp.marked": "Puerto {port} marcado como falso positivo",
  "ports.fp.restored": "Puerto {port} restaurado",
  ...
  "assetDetail.evidence": "Evidencia",
  "assetDetail.evidenceHint":
    "Descarga un paquete de evidencias firmado para este host: puertos abiertos, CVE, cambios e integridad de la auditoría.",
  ...
  "teams.title": "Equipos",
  "teams.subtitle": "Grupos de usuarios con nombre a los que se pueden asignar activos y VLAN.",
  "teams.add": "Añadir equipo",
  "teams.empty": "Aún no hay equipos",
  "teams.emptyBody": "Crea un equipo para agrupar usuarios y asignarle activos y VLAN.",
  "teams.created": "Equipo creado",
  "teams.deleted": "Equipo eliminado",
  "teams.confirmDelete": "¿Eliminar este equipo? Los activos y VLAN asignados a él quedarán sin asignar.",
  "teams.col.name": "Nombre",
  "teams.col.description": "Descripción",
  "teams.col.members": "Miembros",
  "teams.members": "Miembros",
  "teams.membersOf": "Miembros de {name}",
  "teams.noMembers": "Aún no hay miembros.",
  "teams.addMember": "Añadir un miembro…",
  "teams.f.name": "Nombre",
  "teams.f.description": "Descripción",
  "teams.field": "Equipo",
  "teams.unassigned": "Sin equipo",
  "common.save": "Guardar",
  ...
  "tags.hint": "Etiquetas separadas por comas para agrupar y filtrar, p. ej. prod, dmz.",
  ...
  "table.editSelected": "Editar seleccionados",
  "table.bulkEditTitle": "Editar {count} seleccionado(s)",
  "table.keepUnchanged": "Mantener sin cambios",
  "table.apply": "Aplicar",
  "table.bulkUpdateDone": "{count} actualizado(s).",
  "table.stagingStatus": "Estado",
  "table.stagingNew": "Nuevo",
  "table.stagingExists": "Existente",
  "table.stagingNothing": "Nada para importar.",
  "table.stagingImport": "Importar seleccionados",
  ...
  "assets.importStagingTitle": "Revisar importación",
  "assets.rows": "filas",
  ...
  "assets.syncStagingTitle": "Revisar la sincronización de NetBox",
  "assets.syncStagingHint": "Elige qué hosts importar y define los atributos de los seleccionados.",
  "assets.syncKeepDefault": "Mantener predeterminado",
  "assets.syncStatus": "Estado",
  "assets.syncNew": "Nuevo",
  "assets.syncExists": "Existente",
  "assets.syncNothing": "Nada para importar.",
  "assets.syncImportSelected": "Importar seleccionados",
  "assets.hosts": "hosts",
  ...
  "vlans.updated": "VLAN actualizada",
  ...
  "vlans.syncStagingTitle": "Revisar sincronización de VLAN",
  "vlans.importStagingTitle": "Revisar importación de VLAN",
  ...
  "ranges.syncTitle": "Sincronizar rangos desde NetBox",
  "ranges.syncStagingTitle": "Revisar sincronización de rangos",
  "segments.title": "Segmentos de red",
  "segments.subtitle": "Agentes y perfiles de escaneo agrupados por el segmento al que sirven.",
  "segments.unsegmented": "Pool sin segmento",
  "segments.covered": "Cubierto",
  "segments.gap": "Hueco de cobertura",
  "segments.idle": "Inactivo",
  "segments.agents": "Agentes",
  "segments.profiles": "Perfiles de escaneo",
  "segments.noAgents": "Sin agentes",
  "segments.noProfiles": "Sin perfiles",
  "segments.empty": "Aún no hay segmentos",
  "segments.emptyBody": "Registra un agente con un segmento o enruta un perfil de escaneo hacia uno, y aparecerá aquí.",
  ...
  "tasks.bulkUpdated": "{count} actualizado(s)",
  ...
  "changeDetail.back": "Volver a los cambios",
  "changeDetail.notFound": "Cambio no encontrado.",
  "changeDetail.audit": "Registro de auditoría",
  "changeDetail.noAudit": "No hay entradas de auditoría para este cambio.",
  ...
  "users.you": "(tú)",
  "userDetail.back": "Volver a los usuarios",
  "userDetail.notFound": "Usuario no encontrado.",
  "userDetail.edit": "Editar usuario",
  "userDetail.activity": "Actividad",
  "userDetail.noActivity": "No hay actividad registrada para este usuario.",
  ...
  "scans.ports.top100": "Escaneo rápido (top 100 puertos)",
  "scans.ports.db": "Bases de datos y cachés (3306, 5432, 6379…)",
  ...
  "scans.runDetailTitle": "Ejecución de escaneo",
  "scans.back": "Volver a los escaneos",
  "scans.runNotFound": "Ejecución de escaneo no encontrada.",
  "scans.meta.agent": "Agente",
  "scans.meta.scanSource": "Origen del escaneo",
  "scans.meta.created": "Creado",
  "scans.meta.error": "Error",
  "scans.observationsTitle": "Puertos abiertos",
  "scans.groupBy": "Agrupar por",
  "scans.groupNone": "Ninguno",
  "scans.groupHost": "Host",
  "scans.groupPort": "Puerto",
  "scans.changesTitle": "Cambios de este escaneo",
  "scans.exportJira": "Exportar a Jira",
  "scans.exporting": "Exportando...",
  "scans.jiraExported": "{exported} exportado(s) a Jira, {linked} ya vinculado(s).",
  "scans.jiraNotConfigured": "Configura Jira en Ajustes para habilitar la exportación.",
  "scans.noChanges": "Este escaneo no generó ningún cambio.",
  ...
  "audit.action.asset_bulk_created": "Activos creados en masa",
  "audit.action.asset_bulk_deleted": "Activos eliminados en masa",
  "audit.action.asset_bulk_updated": "Activos actualizados en masa",
  ...
  "audit.action.ip_range_bulk_created": "Rangos IP creados en masa",
  "audit.action.ip_range_bulk_deleted": "Rangos IP eliminados en masa",
  "audit.action.ip_range_bulk_updated": "Rangos IP actualizados en masa",
  ...
  "audit.action.scan_run_jira_exported": "Escaneo exportado a Jira",
  ...
  "audit.action.vlan_bulk_created": "VLANs creadas en masa",
  "audit.action.vlan_bulk_deleted": "VLANs eliminadas en masa",
  "audit.action.vlan_bulk_updated": "VLANs actualizadas en masa",
  ...
  "settings.email.verifyTls": "Verificar el certificado TLS",
  "settings.email.verifyTlsHint":
    "Desactívelo para un relay interno que presenta un certificado autofirmado o de CA interna (evita CERTIFICATE_VERIFY_FAILED).",
  ...
  "assistant.act.asset_bulk_create": "Añadir varios activos",
  "assistant.act.asset_bulk_delete": "Eliminar varios activos",
  "assistant.act.asset_bulk_update": "Actualizar varios activos",
  "assistant.act.vlan_bulk_create": "Añadir varias VLANs",
  "assistant.act.vlan_bulk_delete": "Eliminar varias VLANs",
  "assistant.act.iprange_bulk_create": "Añadir varios rangos de IP",
  "assistant.act.iprange_bulk_delete": "Eliminar varios rangos de IP",
