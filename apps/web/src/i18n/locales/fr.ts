...
export const fr: Partial<Record<TKey, string>> = {
  ...
  "ports.fp.show": "Afficher les faux positifs",
  "ports.fp.mark": "Marquer comme faux positif",
  "ports.fp.restore": "Restaurer",
  "ports.fp.badge": "FP",
  "ports.fp.marked": "Port {port} marqué comme faux positif",
  "ports.fp.restored": "Port {port} restauré",
  ...
  "teams.title": "Équipes",
  "teams.subtitle": "Groupes d'utilisateurs nommés auxquels des actifs et des VLAN peuvent être affectés.",
  "teams.add": "Ajouter une équipe",
  "teams.empty": "Aucune équipe pour l'instant",
  "teams.emptyBody": "Créez une équipe pour regrouper des utilisateurs et lui affecter des actifs et des VLAN.",
  "teams.created": "Équipe créée",
  "teams.deleted": "Équipe supprimée",
  "teams.confirmDelete": "Supprimer cette équipe ? Les actifs et VLAN qui lui sont affectés ne le seront plus.",
  "teams.col.name": "Nom",
  "teams.col.description": "Description",
  "teams.col.members": "Membres",
  "teams.members": "Membres",
  "teams.membersOf": "Membres de {name}",
  "teams.noMembers": "Aucun membre pour l'instant.",
  "teams.addMember": "Ajouter un membre…",
  "teams.f.name": "Nom",
  "teams.f.description": "Description",
  "teams.field": "Équipe",
  "teams.unassigned": "Aucune équipe",
  ...
  "tags.hint": "Étiquettes séparées par des virgules pour le regroupement et le filtrage, p. ex. prod, dmz.",
  ...
  "table.editSelected": "Modifier la sélection",
  "table.bulkEditTitle": "Modifier {count} sélectionné(s)",
  "table.keepUnchanged": "Laisser inchangé",
  "table.apply": "Appliquer",
  "table.bulkUpdateDone": "{count} mis à jour.",
  "table.stagingStatus": "Statut",
  "table.stagingNew": "Nouveau",
  "table.stagingExists": "Existant",
  "table.stagingNothing": "Rien à importer.",
  "table.stagingImport": "Importer la sélection",
  "common.active": "Actif",
  ...
  "assets.matchVlans": "Associer les VLAN aux actifs",
  "assets.matchVlansHint":
    "Attribuer à chaque actif sans VLAN celui dont la plage IP le contient.",
  "assets.matching": "Association…",
  "assets.matchVlansDone": "{matched} actifs sur {checked} associés à un VLAN",
  ...
  "vlans.updated": "VLAN mis à jour",
  "vlans.editTitle": "Modifier le VLAN",
  ...
  "ranges.syncStagingTitle": "Vérifier la synchronisation des plages",
  ...
  "tasks.markSelected": "Marquer {status}",
  "tasks.bulkUpdated": "{count} mis à jour",
  ...
  "scans.ports.top100": "Analyse rapide (top 100 ports)",
  "scans.ports.db": "Bases de données et caches (3306, 5432, 6379…)",
  ...
  "scans.groupBy": "Grouper par",
  "scans.groupNone": "Aucun",
  "scans.groupHost": "Hôte",
  ...
  "audit.action.asset_bulk_updated": "Actifs mis à jour en masse",
  ...
  "audit.action.ip_range_bulk_updated": "Plages IP mises à jour en masse",
  ...
  "audit.action.vlan_bulk_updated": "VLAN mis à jour en masse",
  ...
  "assistant.act.asset_bulk_update": "Mettre à jour plusieurs actifs",
