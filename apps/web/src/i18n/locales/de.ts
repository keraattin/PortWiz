...
export const de: Partial<Record<TKey, string>> = {
  ...
  "ports.fp.show": "Fehlalarme anzeigen",
  "ports.fp.mark": "Als Fehlalarm markieren",
  "ports.fp.restore": "Wiederherstellen",
  "ports.fp.badge": "FP",
  "ports.fp.marked": "Port {port} als Fehlalarm markiert",
  "ports.fp.restored": "Port {port} wiederhergestellt",
  ...
  "teams.title": "Teams",
  "teams.subtitle": "Benannte Benutzergruppen, denen Assets und VLANs zugewiesen werden können.",
  "teams.add": "Team hinzufügen",
  "teams.empty": "Noch keine Teams",
  "teams.emptyBody": "Erstelle ein Team, um Benutzer zu gruppieren und ihm Assets und VLANs zuzuweisen.",
  "teams.created": "Team erstellt",
  "teams.deleted": "Team gelöscht",
  "teams.confirmDelete": "Dieses Team löschen? Ihm zugewiesene Assets und VLANs werden nicht mehr zugewiesen.",
  "teams.col.name": "Name",
  "teams.col.description": "Beschreibung",
  "teams.col.members": "Mitglieder",
  "teams.members": "Mitglieder",
  "teams.membersOf": "Mitglieder von {name}",
  "teams.noMembers": "Noch keine Mitglieder.",
  "teams.addMember": "Mitglied hinzufügen…",
  "teams.f.name": "Name",
  "teams.f.description": "Beschreibung",
  "teams.field": "Team",
  "teams.unassigned": "Kein Team",
  ...
  "tags.label": "Tags",
  "tags.hint": "Durch Kommas getrennte Bezeichnungen zum Gruppieren und Filtern, z. B. prod, dmz.",
  ...
  "vlans.updated": "VLAN aktualisiert",
  "vlans.editTitle": "VLAN bearbeiten",
  ...
  "scans.groupBy": "Gruppieren nach",
  "scans.groupNone": "Keine",
