...
def _config_from(s: Settings) -> SettingsConfig:
    return SettingsConfig(
        ...
        netbox_import_assets=s.netbox_import_assets,
        netbox_import_vlans=s.netbox_import_vlans,
        netbox_import_hostnames=s.netbox_import_hostnames,
        netbox_import_descriptions=s.netbox_import_descriptions,
        ...
        cert_expiry_warn_days=s.cert_expiry_warn_days,
        cert_expiry_recheck_hours=s.cert_expiry_recheck_hours,
